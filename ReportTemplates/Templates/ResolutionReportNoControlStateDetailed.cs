        ...
        public override void Outputing(ObservableCollection<Person> personCollection, DateTime firstDate, DateTime lastDate)
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                foreach (var person in personCollection)
                {
                    ...
                    USE DELO_DB
                    /*Все*/
                    SELECT DEPARTMENT.CLASSIF_NAME AS 'PERSON', DOC_RC.FREE_NUM AS 'DOCNUM', RESOLUTION.RESOLUTION_TEXT AS 'RESOLUTION_TEXT', REPLY.PLAN_DATE AS 'PLAN', REPLY.REPLY_TEXT AS 'REPLY_TEXT', REPLY.UPD_DATE AS 'UPD_DATE' FROM RESOLUTION
